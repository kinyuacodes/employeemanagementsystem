    ...
    <!-- Latest countries -->
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title">Registered Department</h3>
                ...
                <div class="container" style="overflow: hidden !important">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <form class="form-inline my-2 my-lg-0 " action="{{route('departments.index')}}" method="GET">
                        <input  type="search" placeholder="departmentName" name="search"class="form-control mr-sm-2">
